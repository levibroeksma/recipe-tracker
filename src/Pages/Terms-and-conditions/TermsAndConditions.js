            ...
            <div className="page-wrapper">
                <div className="page-wrapper-inner">
                    ...
                    <h1>General terms and conditions</h1>
                        ...
                        <h2>Why do you need to draw up general terms and conditions?</h2>
                        <p>
                        ...
                        <p>
                            <ul>
                                <li><strong>Liability:</strong> As an entrepreneur, in principle you can be held liable for all direct and indirect damage. Although you may never rule out your liability entirely, you can limit it via your terms and conditions.</li>
                                <li><strong>Payment term:</strong> The legal payment term for invoices is 30 days. If you want a shorter payment term for your invoices, you will need to have explicitly agreed this via your general terms and conditions or in a contract. It is also possible to extend the payment term.</li>
                                <li><strong>Retention of title:</strong> By including retention of title, you can ensure that as an entrepreneur you remain the owner of the item you deliver. This means that as owner, you have the right to reclaim the item as long as the invoice has not been paid. This also is the case if your counterparty goes bankrupt or into liquidation.</li>
                                <li><strong>Guarantee:</strong> If you are selling to consumers, your general terms and conditions may not infringe upon the legal guarantees that customers have. This is different than in sales to entrepreneurs, where there is more flexibility.</li>
                                <li><strong>Cancellation policy:</strong> If you provide services, in particular events, entertainment, or holiday accommodation, your terms and conditions may include your cancellation policy. Your cancellation policy outlines what the conditions for cancellation are, such as the cancellation period and any costs associated with cancellation.</li>
                            </ul>
                        </p>
                        ...
                        <p>
                            ...
                            <h2>Filing general terms and conditions</h2>
                        <p>
                    You can file your general terms and conditions with the Chamber of Commerce or the Court. Although this is not an obligation, it can prove to be useful. This means that they are easily retrievable and have a stronger evidentiary function, while it also creates a professional impression.
                        ...
                        <p>
                            <em>Last updated on 12 May 2021</em>
                        </p>
                    </div>
                </div>
            </div>
