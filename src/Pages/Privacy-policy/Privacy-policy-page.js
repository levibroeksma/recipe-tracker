            ...
            <div className="page-wrapper">
                <div className="page-wrapper-inner">
                    ...
                    <div className="privacy-holder">
                        <p>
                            <em>Last updated: June 07, 2021</em>
                        </p>
                        <p>
                        ...
                        <p>
                            <ul>
                                ...
                                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to RecipeTracker.</li>
                                ...
                                <li><strong>Website</strong> refers to RecipeTracker, accessible from recipetracker.com</li>
                        ...
                        <p>
                            <ul>
                                <li>By email: <a href="mailto:info@recipetracker.com">info@recipetracker.com</a></li>
                                <li>By visiting this page on our website: <Link to="/contact">recipetracker.com/contact</Link></li>
                                <li>By phone number: <a href="tel:+31123456789">+31123456789</a></li>
                            </ul>
                        </p>
                    </div>
                </div>
